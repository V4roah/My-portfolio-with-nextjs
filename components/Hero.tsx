    ...
    >
      ...
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          ...
          <TextEffect />
          <p className="mt-[2rem] text-[1.5rem] text-[#ffffff92] ">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat
            consequuntur sapiente tempora incidunt ab. Ut fuga vitae id
            molestias exercitationem ex facilis quis. Eum vitae molestias illo
            asperiores dignissimos necessitatibus.
          </p>
          <div className="mt-[2rem] flex-col space-y-6 sm:space-y-0 sm:flex sm:flex-row items-center sm:space-x-6">
            ...
            <button className="flex items-center space-x-2">
              <PlayCircleIcon className="w-[4rem] h-[4rem]  transition-all duration-200 text-[#55e6a5]" />
